...
import csv
from .models import Event, Registration, UserProfile, PointsTransaction, Announcement
...
class RegistrationInline(admin.TabularInline):
    ...
    fields = ("user", "status", "registered_at", "checked_in_at", "notes")
...
class EventAdmin(admin.ModelAdmin):
    list_display = ("title", "start_datetime", "end_datetime", "venue", "capacity", "pinned", "created_by")
    list_filter = ("pinned", "is_public", "start_datetime", "created_at")
    search_fields = ("title", "description", "venue", "created_by__username", "created_by__email")
    date_hierarchy = "start_datetime"
    readonly_fields = ("created_at", "updated_at")
    inlines = [RegistrationInline]
    ordering = ("-start_datetime",)
    fieldsets = (
        (None, {"fields": ("title", "description", "created_by", "image", "pinned")}),
...
class RegistrationAdmin(admin.ModelAdmin):
    list_display = ("user", "event", "status", "registered_at", "checked_in_at")
...
class AnnouncementAdmin(admin.ModelAdmin):
    list_display = ("title", "created_by", "created_at", "expires_at", "pinned")
    list_filter = ("pinned",)
